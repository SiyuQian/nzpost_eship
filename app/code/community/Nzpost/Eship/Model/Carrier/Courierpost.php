<?php
class Nzpost_Eship_Model_Carrier_CourierPost extends Mage_Shipping_Model_Carrier_Abstract
implements Mage_Shipping_Model_Carrier_Interface {
    ...
    if ($doCalulate==0)
    {
      $price = $this->getConfigData('price');
        ...
        try {
            $eShipApiKey = Mage::helper('eship')->getEShipApiKey();
            if ($eShipApiKey == "") {
              return false;
            }
            ...
            Mage::log($e->getMessage(), null, eShip.log);
        }
    }
